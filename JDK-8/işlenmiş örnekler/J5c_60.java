// J5c_60.java: TableDemo (TabloGösterisi) örneði.
...
/* J5c_47.java=SimpleTableDemo gibidir; ancak standart JTable yerine
 * kendi Tablom sýnýfý kullanýlmaktadýr.*/
public class J5c_60 extends JPanel {
    ...
    private static void yaratVeGösterGUI() {
        ...
        J5c_60 yeniÝçerikPanosu = new J5c_60(); // Kurucuyu çaðýrýr...
    ...
    class Tablom extends AbstractTableModel {
        ...
        Object[][] tabloVerileri = {
            {new Long ("43882313080"), "Haným Amanat Yavaþ", "Yeþilyurt", "1 Ekim 1932", "4 Mayýs 2014", new Integer (82), new Boolean (true), "Yok"},
