// J5c_66.java: TableSelectionDemo (TabloSeçimiGösterisi) örneði.
...
public class J5c_66 extends JPanel implements ActionListener {
    ...
    private static void yaratVeGösterGUI() {
        JFrame çerçeve = new JFrame ("Tablo Seçimi Gösterisi");
        çerçeve.setDefaultCloseOperation (3); // 3=JFrame.EXIT_ON_CLOSE
        J5c_66 yeniÝçerikPanosu = new J5c_66(); // Kurucuyu çaðýrýr...
