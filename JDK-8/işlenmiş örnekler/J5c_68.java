// J5c_68.java: TableSorterDemo (TabloSýralayýcýGösterisi) örneði.
...
/* Bu program da J5c_60.java=TableDemo.java ve J5c_67.java=TableSortDemo.java
 * programlarý gibidir. Ancak burada sýralama "tablo.setAutoCreateRowSorter(true);"
 * hazýr metoduyla deðil, J5c_68x.java=TableSorter.java kullanýcý-tanýmlý
 * programla yapýlmaktadýr. Sýralama tekrar orijinal sýrasýza çevrilebilmektedir.
 */
public class J5c_68 extends JPanel {
    private static boolean yazýlsýnMý = false;

    public J5c_68() {// Kurucu...
        super (new GridLayout (1,0));

        J5c_68x sýralayýcý = new J5c_68x (new Tablom()); // YENÝ EKLENTÝ...
        //JTable tablo = new JTable (new Tablom()); // ESKÝ ÝPTAL...
        JTable tablo = new JTable (sýralayýcý); // YENÝ...
        sýralayýcý.setTableHeader (tablo.getTableHeader()); // YENÝ EKLENTÝ...
        tablo.setPreferredScrollableViewportSize (new Dimension (1100, 80));

        // Kolon baþlýklarýnýn ipucu açýklamasý...
        tablo.getTableHeader().setToolTipText (
                "Sýralamayý belirlemek için týklayýn; Ýkinci sýralamayý belirlemek için de Ctrl-Týklayýn.");
    ...
    private static void yaratVeGösterGUI() {
        ...
        J5c_68 yeniÝçerikPanosu = new J5c_68(); // Kurucuyu çaðýrýr...
