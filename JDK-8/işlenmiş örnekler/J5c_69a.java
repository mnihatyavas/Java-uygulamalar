// J5c_69a.java: TableToolTipsDemo (TabloÝpuçlarýGösterisi) örneði.
 ...
 */
public class J5c_69a extends JPanel {
    ...
    private static void yaratVeGösterGUI() {
        JFrame çerçeve = new JFrame ("Tablo Ýpuçlarý Gösterisi");
        çerçeve.setDefaultCloseOperation (3); // 3=JFrame.EXIT_ON_CLOSE
        JComponent yeniÝçerikPanosu = new J5c_69a(); // Kurucuyu çaðýrýr...
