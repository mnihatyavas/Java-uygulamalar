/* J4a_1.java: QuoteClientApplet (HikayeMüþterisiApleti) örneði.
*
* <applet code="J4a_1.class" width="320" height="320"> </applet>
*/
...
public class J4a_1 extends JApplet implements ActionListener {
    ...
    public void init() {
        ...
        try {
            address = InetAddress.getByName(host); // "127.0.0.1"
